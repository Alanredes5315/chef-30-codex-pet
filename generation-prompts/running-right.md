Create one horizontal animation strip for Codex pet `chef-30`, state `running-right`.
...
Identity: same pet in every frame: Original chibi pixel-art basketball superstar inspired by Stephen Curry: warm medium-brown skin, short dark curls with fade, close beard, bright eyes and clear mouthguard, blue-and-gold number 30 uniform without team names or logos, white shoes, orange basketball. Signature actions: crossover dribble, three-point jump shot, follow-through, and playful night-night celebration. Preserve right-handed ball logic and correctly oriented number 30.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
